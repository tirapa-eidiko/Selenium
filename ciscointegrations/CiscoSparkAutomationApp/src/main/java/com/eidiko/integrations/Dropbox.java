...
public class Dropbox implements Runnable {
	...
	public Dropbox(Properties prop) {
		this.prop = prop;
		xls = new ReadExcelData(prop.getProperty("dropboxfile"));
	...
	public void authorizeDropbox() throws Exception{
		try{
			// Enter Dropbox email id
