...
public class Twitter implements Runnable {
	...
	final static Logger logs = Logger.getLogger(Twitter.class);
	...
	public Twitter(Properties prop) {
		this.prop = prop;
		xls = new ReadExcelData(prop.getProperty("twitterfile"));
	...
	public void authorizeTwitter() throws Exception{
		try{
			// Enter Twitter email id
