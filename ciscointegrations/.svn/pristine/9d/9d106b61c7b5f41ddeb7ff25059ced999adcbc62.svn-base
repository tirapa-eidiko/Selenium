...
public class Mailchimp  implements Runnable{
	...
	public Mailchimp(String sheetPath){
	...
	public void mailchimp() throws Exception{
		...
		try{
			...
			driver.close();
			throw new Exception("mailchimp Exception : "+e.getMessage());
		}
		...
		System.out.println("mailchimp Click Add Button");
		...
		System.out.println("mailchimp Authentication");
